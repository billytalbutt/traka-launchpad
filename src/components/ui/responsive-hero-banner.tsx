            ...
            <div className="z-10 relative">
                <div className="sm:pt-28 md:pt-32 lg:pt-40 max-w-7xl mx-auto pt-28 px-6 pb-16">
                    ...
                    <div className="mx-auto mt-20 max-w-5xl">
                        ...
                        <div className="flex flex-wrap animate-fade-slide-in-2 text-white/70 mt-6 items-center justify-center gap-8">
                            {partners.map((partner, index) => (
                                <div
                                    key={index}
                                    className="inline-flex items-center justify-center bg-center w-[130px] h-[36px] bg-contain bg-no-repeat opacity-80"
                                    style={{
